...
print('[{0:-05d}] [{1:-05d}] [{2:-05d}]'.format(1,-2,3)) # 의미없음
print('[{0:<5d}] [{1:<5d}] [{2:<5d}]'.format(1,-2,3))     # 정렬
print('-' * 40)

#print('[{0:$5d}] [{1:$5d}] [{2:$5d}]'.format(1,-2,3))     # 정렬
print('[{0:05d}] [{1:05d}] [{2:05d}]'.format(1,-2,3))        # 채움문자
print('[{0:0=5d}] [{1:0=5d}] [{2:0=5d}]'.format(1,-2,3))        # 채움문자
print('[{0:$<5d}] [{1:$<5d}] [{2:$<5d}]'.format(1,-2,3))     # 채움문자
print('[{0:$>5d}] [{1:$>5d}] [{2:$>5d}]'.format(1,-2,3))     # 채움문자
print('[{0:$^5d}] [{1:$^5d}] [{2:$^5d}]'.format(1,-2,3))     # 채움문자
print('[{0:\^5d}] [{1:\^5d}] [{2:\^5d}]'.format(1,-2,3))     # 채움문자
print('[{0:원>5d}] [{1:원>5d}] [{2:원>5d}]'.format(1,-2,3))     # 채움문자
...
print('원주율 [{0:5.5f}]'.format(math.pi))
print('-' * 40)
